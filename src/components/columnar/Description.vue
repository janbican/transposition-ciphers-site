<template>
  <div class="description">
    <b-row class="justify-content-md-center mt-5">
      <b-col md="9">
        <p>
          Základní transpoziční šifra. Otevřený text se zapisuje do tabulky,
          přičemž šifrovaný se získává přepsáním po sloupcích. Počet sloupců a
          pořadí, ve kterém jsou přepisovány, je určeno klíčem.
        </p>

        <p>
          Klíčem může být libovolné slovo. Jeho délka určuje počet sloupců
          tabulky. <strong>Permutační vyčíslení</strong> pak určuje pořadí, v
          jakém jsou sloupce přepisovány do šifrovaného textu.
        </p>

        <p>
          Permutační vyčíslení přiřazuje každému písmenu klíče číslo
          reprezentující pořadí podle abecedy.
        </p>
        ...
        <p>
          S otevřeným textem se pracuje bez mezer a interpunkce, zpravidla je
          psán malými písmeny, tedy "bylijsteodhaleniutecte".
        </p>

        <p>1. Zvolíme klíč. Například "slovo".</p>
        <p>2. Určíme permutační vyčíslení (viz výše)</p>
        <p>
          3. Otevřený text zapíšeme do tabulky, v jejímž záhlaví máme klíč a
          jeho permutační vyčíslení. Počet sloupců tabulky je určen délkou
          klíče, v našem případě budeme mít pět sloupců. Otevřený text píšeme po
          řádcích, první řádek bude vypadat následovně:
        </p>
        ...
        <p>
          4. Šifrovaný text získáme přepsáním sloupců v pořadí určeném
          permutačním vyčíslením. Začneme tedy druhým sloupcem (vyznačen). A
          pokračujeme dalšími.
        </p>
        ...
        <p>
          V našem případě je výsledek 2 úplné sloupce. Podotýkám, že se jedná o
          počet úplných sloupců od počátku klíče, permutační vyčíslení nehraje v
          tomto směru žádnou roli.
        </p>

        <p>
          4. Šifrovaný text zapíšeme posutpně do sloupců v pořadí daném
          permutačním vyčíslením, přičemž dbáme na (ne)úplnost sloupců. Po
          prvním zapsaném sloupci bude vypadat tabulka následovně:
        </p>
        <p>
